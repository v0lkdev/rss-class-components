    ...
    render() {
        return (
            <li>
                ...
                First publish year - <span className="description-data">{this.props.publishYear}</span>;
                Edition count - <span className="description-data">{this.props.editionCount}</span>
            </li>
        )
    }
}
